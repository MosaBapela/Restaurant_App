  ...
  return (
    <SafeAreaView style={styles.container}>
      <View style={styles.content}>
        ...
        <Text style={styles.subtitle}>Thanks for visiting — we hope to see you again soon.</Text>
        <Button title="Back to Welcome" onPress={() => navigation.reset({ index: 0, routes: [{ name: 'Auth', params: { screen: 'Welcome' } }] })} fullWidth style={styles.button} />
      </View>
    </SafeAreaView>
  );
};
